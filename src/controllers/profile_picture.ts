...
export const uploadProfilePicture = async (
	...
	try {
		...
		try {
			...
			ctx.response.body = {
				error: "File too large or upload interrupted.",
			};
			return;
		}
		...
		log(`[${requestId}] File received. Memory: ${!!file
			.content}, DiskPath: ${file.filename}`);
		...
		if (client) {
			...
			const publicUrl = `${baseUrl}/profile-picture/${
